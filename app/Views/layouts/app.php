...
<body class="antialiased bg-gray-200 text-gray-900 font-sans">
    ...
    <nav class="bg-white border-gray-200 px-2 md:px-4 py-2.5 dark:bg-gray-900">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="/" class="flex items-center">
                <img src="/assets/img/logo.png" class="mr-3 h-6 sm:h-9" alt="Logo NeoNess">
            ...
            <div class="flex items-center md:order-2">
                ...
                <div class="z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 hidden"
                    ...
                    style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(507px, 76px);">
                    <div class="py-3 px-4">
                ...
                <ul class="flex flex-col mt-4 text-sm font-medium md:flex-row md:space-x-8 md:mt-0">
                    ...
                    <li>
                        ...
                        <div id="mega-menu-icons-dropdown"
                            class="grid absolute z-10 grid-cols-2 w-auto text-sm bg-white rounded-lg border border-gray-100 shadow-md dark:border-gray-700 md:grid-cols-3 dark:bg-gray-700 hidden"
                            data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom"
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(112px, 70px);">
                                ...
                                <ul class="space-y-4" aria-labelledby="mega-menu-icons-dropdown-button">
                                    <li>
                                        <a href="#"
                                            ...
                                            <svg class="mr-2 w-4 h-4 text-gray-400 dark:text-gray-500 group-hover:text-blue-600 dark:group-hover:text-blue-500"
    ...
    <footer class="p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/"
                class="hover:underline">NeoNess™</a>. Tous les droits sont réservés.
        </span>
        <ul class="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
            <li>
                <a href="about" class="mr-4 hover:underline md:mr-6 ">À propos de nous</a>
            </li>
            <li>
                <a href="privacy_policy" class="mr-4 hover:underline md:mr-6">Politique de confidentialité</a>
            </li>
