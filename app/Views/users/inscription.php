<div class="items-center h-screen w-full">
    <div class="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-lg md:mx-auto">
        <span class="block w-full text-xl  font-bold mb-4">Inscription</span>
        <form class="mb-4" action="/inscription" method="post">
            ...
            <div class="mb-4 md:w-full">
                ...
                <input class="w-full border rounded p-2 outline-none focus:shadow-outline" type="text" name="nom"
                    id="nom" placeholder="Votre nom" value="<?= set_value('nom'); ?>">
            </div>
            <!-- Prenom -->
            <div class="mb-4 md:w-full">
                ...
                <input class="w-full border rounded p-2 outline-none focus:shadow-outline" type="text" name="prenom"
                    id="prenom" placeholder="Votre prenom" value="<?= set_value('prenom'); ?>">
            </div>
            <!-- Pseudo -->
            <div class="mb-4 md:w-full">
                ...
                <input class="w-full border rounded p-2 outline-none focus:shadow-outline" type="text" name="pseudo"
                    id="pseudo" placeholder="Votre pseudo" value="<?= set_value('pseudo'); ?>">
            </div>
            <!-- Email -->
            <div class="mb-4 md:w-full">
            ...
            <div class="mb-6 md:w-full">
                ...
                <input class="w-full border rounded p-2 outline-none focus:shadow-outline" type="password"
                    name="password" id="password" placeholder="Votre mot de passe" value="">
            </div>
            <!-- confirmation password -->
            <div class="mb-6 md:w-full">
                <label for="cpassword" class=" font-bold  block text-xs mb-1">Confirmez le mot de passe</label>
                <input class="w-full border rounded p-2 outline-none focus:shadow-outline" type="password"
                    name="cpassword" id="cpassword" placeholder="Confirmez votre mot de passe" value="">
            </div>
            ...
            <button type="submit"
                class="bg-green-500 hover:bg-green-700 text-white text-sm font-semibold px-4 py-2 rounded">Inscription</button>
        </form>

        <a href="/inscription" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">J'ai déjà un
            compte</a>
